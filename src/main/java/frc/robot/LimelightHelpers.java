...
public class LimelightHelpers {
    ...
    public static final Map<String, DoubleArrayEntry> doubleArrayEntries = new ConcurrentHashMap<>();
    ...
    public static void SetRobotOrientation_INTERNAL(String limelightName, double yaw, double yawRate, 
        double pitch, double pitchRate, 
    ...
    public static boolean SYNCH_TAKESNAPSHOT(String tableName, String snapshotName) {
